...
#     ])
    ...
    mask_nii = '/storage/Ayantika/Data_final/ixi_raw/IXI_preprocessed_Data/mask/**T2_mask.nii.gz'
    ...
    train_loader = torch.utils.data.DataLoader(h5cacheds,batch_size = 24,shuffle = True)
    # Log output
    ...
    # else:
    #     log_writer = None
    model_dir = '/storage/Ayantika/analyse_1/Rashmi/Swin-MAE/saved_model_T2'
    save_dir = '/storage/Ayantika/analyse_1/Rashmi/Swin-MAE/output_dir_T2/tb'
...
#         return lr
   ...
   # scheduler = torch.optim.lr_scheduler.LambdaLR(optimizer, lr_lambda=lr_lambda)
    ...
    #model_without_ddp.load_state_dict(torch.load('/storage/Ayantika/analyse_1/Rashmi/Swin-MAE/output_dir_T2/checkpoint-10.pth')['model'])
